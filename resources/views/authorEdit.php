...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="ml-4 text-dark">Edit Author</h1>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            ...
            <form action='../../src/author.php' method='POST'>
                ...
                <div class="form-group">
                    <label>Name</label>
                    <input type="text" class="form-control" name="name" placeholder="Please enter author name" value="<?php echo $result['name'] ?>" required>
                </div>
